  ...
  module RubySamlFrozen081
    class Settings
      ...
      def get_sp_cert
        cert = nil
        if self.certificate
          formated_cert = OneLogin::RubySamlFrozen081::Utils.format_cert(self.certificate)
      ...
      def get_sp_key
        private_key = nil
        if self.private_key
          formated_private_key = OneLogin::RubySamlFrozen081::Utils.format_private_key(self.private_key)
      ...
      DEFAULTS = {
        ...
        :security                                  => {
          ...
          :embed_sign               => false,
          :digest_method            => XMLSecurityFrozen081::Document::SHA1,
          :signature_method         => XMLSecurityFrozen081::Document::SHA1
        },
