...
class RequestTest < Test::Unit::TestCase
  ...
  context "Logoutrequest" do
    ...
    should "create the deflated SAMLRequest URL parameter" do
      ...
      unauth_url = OneLogin::RubySamlFrozen081::Logoutrequest.new.create(settings)
    ...
    should "support additional params" do
      ...
      unauth_url = OneLogin::RubySamlFrozen081::Logoutrequest.new.create(settings, { :hello => nil })
      assert unauth_url =~ /&hello=$/

      unauth_url = OneLogin::RubySamlFrozen081::Logoutrequest.new.create(settings, { :foo => "bar" })
    ...
    should "set sessionindex" do
      ...
      unauth_url = OneLogin::RubySamlFrozen081::Logoutrequest.new.create(settings, { :name_id => "there" })
      inflated = decode_saml_request_payload(unauth_url)
    ...
    context "consumation of logout may need to track the transaction" do
      should "have access to the request uuid" do
        ...
        unauth_req = OneLogin::RubySamlFrozen081::Logoutrequest.new
