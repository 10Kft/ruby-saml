...
class RequestTest < Test::Unit::TestCase
  ...
  context "Authrequest" do
    should "create the deflated SAMLRequest URL parameter" do
      ...
      auth_url = OneLogin::RubySamlFrozen081::Authrequest.new.create(settings)
    ...
    should "accept extra parameters" do
      ...
      auth_url = OneLogin::RubySamlFrozen081::Authrequest.new.create(settings, { :hello => "there" })
      assert auth_url =~ /&hello=there$/

      auth_url = OneLogin::RubySamlFrozen081::Authrequest.new.create(settings, { :hello => nil })
    ...
    should "create the saml:AuthnContextClassRef element correctly" do
      ...
      auth_doc = OneLogin::RubySamlFrozen081::Authrequest.new.create_authentication_xml_doc(settings)
